...
RUN curl -s -L https://github.com/cfstacks/stacks/releases/download/v0.3.0/stacks-0.3.0-py34-linux-x86_64.pex -o /usr/bin/stacks && chmod +x /usr/bin/stacks

...
RUN curl -s -L https://github.com/cfstacks/stacks/releases/download/v0.3.2-rc1/stacks-0.3.2-rc1-py34-linux-x86_64.pex -o /usr/bin/stacks && chmod +x /usr/bin/stacks
...
RUN curl -s -L https://github.com/UKHomeOffice/vaultctl/releases/download/v0.0.4/vaultctl_v0.0.4_linux_x86_64.gz -o /usr/bin/vaultctl.gz && \

...
RUN curl -s -L https://github.com/cfstacks/stacks/releases/download/v0.2.8.rc1/stacks-0.2.8.rc1-linux-amd64.pex -o /usr/bin/stacks && chmod +x /usr/bin/stacks
